...
export default function ShareButtons({ url, title }) {
  ...
  // Create full URL including domain
  ...
  return (
    <div className="flex flex-col items-start space-y-4">
      <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Share this article</h4>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`flex items-center justify-center w-10 h-10 rounded-full text-white transition-all ${copied ? 'bg-green-500' : 'bg-gray-600 hover:bg-gray-700'}`}
